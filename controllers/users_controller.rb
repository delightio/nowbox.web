...
module Aji
  class API
    ...
    resource :users do
      ...
      #
      # __Required params__ `user_id` the unique id of the user.  
      ...
      # __Required params__ `first_name`: The first name of the user.  
      # __Optional params__ `last_name`: The last name of the user.
      post '/' do
