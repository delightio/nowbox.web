shared_examples_for "any content holder" do
  describe "#refresh_content(force)" do
    ...
    it "index given object only if it has content_videos" do
      subject.should_receive(:update_tank_indexes_if_searchable).once
      subject.refresh_content :force
puts
puts "===================="
puts
      # We won't get any more new videos right after
      subject.should_receive(:update_tank_indexes_if_searchable).never
